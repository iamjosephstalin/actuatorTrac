...
class ActuatorModelController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new ActuatorModel());
    ...
    {
        $show = new Show(ActuatorModel::findOrFail($id));
    ...
    {
        $form = new Form(new ActuatorModel());
